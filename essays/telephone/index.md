---
title: "The Telegraph to Telephone Pipeline."
layout: scrollstory
header-image: images/bells phone.webp
thumbnail: images/bells phone.webp
...
Before the telephone, communication technologies required specialized knowledge from the assistance of a third-party. The telephone distrupted this model by allowing everyday individuals to directly transmit their own voices across any distance. In doing so, it removed layers of expert mediation that had previously defined LDC. Its significance was not just in making communication faster between people, but by simplifying the experience for the everyday users. The telephone made a process that was preiously exclusive process accessible broadly. Thanks to Bell, power was *no longer with telegraphic experts*, instead it was in the homes of average citizens. 
...
Stockholm Centre for Business History. "The telephone is the instrument of the devil". *Telefonaktiebolaget LM Ericsson and Centre for Business History*.
