...
To understand why the telephone was so threatening, you have to understand what it replaced.

The *Encyclopaedia Britannica* was founded in Edinburgh in 1768 with an explicit promise: its articles would be written by recognized authorities in each field. That model—credentialed experts producing vetted, stable knowledge—defined reference works for two centuries. By the twentieth century, Britannica had become a cultural institution. Owning a set was a marker of middle-class aspiration; its contributors included Nobel laureates and heads of state. (I DONT WANNA TAKE AWAY FROM ANYTHING HERE IDK WHAT HE DID)
{% endcapture %}
...
{% include typography/pullquote.html text="\"Mr. Watson, come here, I want to see you.\" — Alexander Bell, Telephone inventor." %}

## The Telegraph Elite: Masters of Speed and Code

hgowhfoi discuss telegraph expertise before disruption
...
{% capture aftermath_text %}
 there is code here for capture aftermath text idk what that does lol
